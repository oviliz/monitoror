...
func (_m *Manager) RegisterTile(tileType models.TileType, variant string) {
...
func (_m *Manager) EnableDynamicTile(tileType models.TileType, variant string, clientConfigValidator utils.Validator, _a3 builder.DynamicTileBuilder) {
...
func (_m *Manager) EnableTile(tileType models.TileType, variant string, clientConfigValidator utils.Validator, path string, initialMaxDelay int) {
