...
import (
	...
	_jenkinsModels "github.com/monitoror/monitoror/monitorables/jenkins/models"
...
`
	...
	usecase.EnableTile(jenkins.JenkinsBuildTileType, "variant1", &_jenkinsModels.BuildParams{}, "/jenkins/variant1", 1000)
...
`
	...
	store := cache.NewGoCacheStore(time.Second, time.Second)
	usecase := initConfigUsecase(nil, store)
	usecase.EnableDynamicTile(jenkins.JenkinsMultiBranchTileType, DefaultVariant, &_jenkinsModels.MultiBranchParams{}, mockBuilder)
...
`
	...
	usecase.EnableTile(jenkins.JenkinsBuildTileType, "variant1", &_jenkinsModels.BuildParams{}, "/jenkins/variant1", 1000)
	usecase.EnableDynamicTile(jenkins.JenkinsMultiBranchTileType, DefaultVariant, &_jenkinsModels.MultiBranchParams{}, mockBuilder)
	usecase.EnableDynamicTile(jenkins.JenkinsMultiBranchTileType, "variant1", &_jenkinsModels.MultiBranchParams{}, mockBuilder2)
